    ...
    <section id="portfolio">
      ...
      <div className="project-item">
        <div className="project-info">
          ...
          <p className="languages">
            React.js | JavaScript | HTML | CSS | Responsive Web Design
          </p>
          <p className="detail">
            Alexander Realty is a landing page for the real estate company
            website built with React.js.
          </p>

          <a
            href="https://alexander-realestate.netlify.app"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://github.com/annjung27/React_RealEstate_Website"
            target="_blank"
            rel="noreferrer"
          >
            <Button className="view-button">View GitHub</Button>
          </a>
        </div>
      ...
      <div className="project-item">
        <div className="project-info">
          ...
          <p className="type">Personal Project</p>
          <p className="languages">
            Java | Spring MVC | Spring Boot | JSP | MySQL | RTF{" "}
          </p>
          <p className="detail">
            Something Learned Everyday is a note taking blog for users to create
            and save notes about their daily learning and share them with other
            users. Users can create and save contents to database, read, view,
            retrieve them from the database, and edit and delete contents.
          </p>

          <a
            href="https://github.com/annjung27/Java_NoteBlog_SLE"
            target="_blank"
            rel="noreferrer"
          >
            <Button className="view-button">View GitHub</Button>
      ...
      <div className="project-item">
        <div className="project-info">
          ...
          <p className="type">Personal Project</p>
          <p className="languages">
            React.js | HTML | CSS | Node.js | Express | Mongoose | MongoDB |
            Bootstrap
          </p>
          <p className="detail">
            Yoga Together is a e-commers website for virtual yoga classes built
            with MERN stack. Users can view list of virtual yoga classes and
            teachers' profile, and add them into 'My Class' for enrollment.
            Enrolled students can communicate with other students about their
            daily life and yoga story by creating, viewing, editing, deleting
            posts in Community Dashboard page. Also, users can view outdoor yoga
            events information in Event page.
          </p>

          {/* <a href='http://54.176.93.190/home' target='_blank' rel='noreferrer'><Button className='view-button'>View Website</Button></a> */}
          <a
            href="https://github.com/annjung27/MERN_Project_Deployment"
            target="_blank"
            rel="noreferrer"
          >
            <Button className="view-button">View GitHub</Button>
